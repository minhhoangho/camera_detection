...
from src.Apps.base.locale.translator import Translator
...
# class Translated(Strings):
#     pass
#
#
# class ApiErrTranslator(Translator):
#     COLLATION = Translated
#
#     def __getattr__(self, key) -> Any:
#         result: Any = super().__getattr__(key)
#         return result
