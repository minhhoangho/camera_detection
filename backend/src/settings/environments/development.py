...
from src.settings.components.database import DATABASES
...
def _custom_show_toolbar(request):  # pragma: no cover
    """Only show the debug toolbar to users with the superuser flag."""
    return DEBUG and request.user.is_superuser


DEBUG_TOOLBAR_CONFIG = {
    "SHOW_TOOLBAR_CALLBACK": "src.settings.environments.development._custom_show_toolbar",
}
